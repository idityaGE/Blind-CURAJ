...
import { Colors, Liquid } from '@/components/liquid-gradient/liquid-gradient';
...
const GitHubButton: React.FC = () => {
  ...
  return (
    <div className='flex justify-center'>
      <a
        href='https://github.com/idityaGE/Blind-CURAJ'
        target='_blank'
      ...
      >
        ...
        >
          <span className=' flex  items-center justify-between px-4 gap-2   rounded-lg group-hover:text-yellow-400 text-white text-xl font-semibold tracking-wide whitespace-nowrap'>
            ...
            <span className='sm:inline-block hidden'>Connect</span>
          </span>
        </button>
      </a>
    </div>
